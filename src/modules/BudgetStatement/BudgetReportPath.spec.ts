...
it("correctly reduces paths", () => {
  let p = BudgetReportPath.fromString(
    "makerdao/core-units/SES-001/*:1,2,3",
  ).reduce();
...
it("correctly parses path segment filters and groups", () => {
  const segments: any = [
    ...
    [
      "makerdao:discontinued",
      "makerdao:discontinued",
      ["makerdao"],
      ["discontinued"],
    ],
    [
      "SES-001,PE-001:discontinued",
      "SES-001,PE-001:discontinued",
      ["SES-001", "PE-001"],
      ["discontinued"],
    ],
    ...
    [
      "makerdao:discontinued,category",
      "makerdao:discontinued,category",
      ["makerdao"],
      ["discontinued", "category"],
    ],
    [
      "SES-001,PE-001:discontinued,category",
      "SES-001,PE-001:discontinued,category",
      ["SES-001", "PE-001"],
      ["discontinued", "category"],
    ],
