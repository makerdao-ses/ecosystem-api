...
export async function seed(knex) {
  ...
  await knex("CoreUnit")
    ...
    .update({
      ...
      shortCode: "DEVPOOL",
      image:
        "https://makerdao-ses.github.io/ecosystem-dashboard/ecosystem-actors/DEVPOOL/DEVPOOL_logo.png",
    });
  ...
  await knex("CoreUnit")
    ...
    .update({
      ...
      shortCode: "L2BEAT",
      image:
        "https://makerdao-ses.github.io/ecosystem-dashboard/ecosystem-actors/L2BEAT/L2BEAT_logo.png",
    });
  ...
  await knex("CoreUnit")
    ...
    .update({
      ...
      image:
        "https://makerdao-ses.github.io/ecosystem-dashboard/ecosystem-actors/STEAKHOUSE/STEAKHOUSE_logo.png",
    });
  ...
  await knex("CoreUnit")
    ...
    .update({
      ...
      image:
        "https://makerdao-ses.github.io/ecosystem-dashboard/core-units/sas-001/SAS_logo.png",
    });
