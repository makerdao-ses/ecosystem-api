...
export function up(knex) {
  return knex.schema
    ...
    .createTable("Stakeholder", function (table) {
      ...
      table
        .foreign("stakeholderContributorId")
        .references("Contributor.id")
        .onDelete("CASCADE");
      table.integer("stakeholderCuId");
      table
        .foreign("stakeholderCuId")
        .references("CoreUnit.id")
        .onDelete("CASCADE");
    })
    ...
    .createTable("RoadmapStakeholder", function (table) {
      ...
      table
        .foreign("stakeholderRoleId")
        .references("StakeholderRole.id")
        .onDelete("CASCADE");
    })
    ...
    .createTable("RoadmapOutput", function (table) {
      ...
      table
        .foreign("outputTypeId")
        .references("OutputType.id")
        .onDelete("CASCADE");
    })
    ...
    .createTable("Task", function (table) {
      ...
      table
        .enu(
          "taskStatus",
          ["ToDo", "InProgress", "Done", "WontDo", "Blocked", "Backlog"],
          {
            useNative: true,
            enumName: "TaskStatus",
          },
      ...
      table
        .enu("confidenceLevel", ["High", "Medium", "Low"], {
          useNative: true,
    ...
    .createTable("Review", function (table) {
      ...
      table
        .enu("reviewOutcome", ["Red", "Yellow", "Green"], {
          useNative: true,
