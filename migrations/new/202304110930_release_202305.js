...
export async function up(knex) {
  ...
  return knex.schema
    ...
    .createTable("SnapshotAccount", function (table) {
      ...
      table
        .foreign("groupAccountId")
        .references("id")
        .inTable("SnapshotAccount");
      table.integer("upstreamAccountId").unsigned();
      table
        .foreign("upstreamAccountId")
        .references("id")
        .inTable("SnapshotAccount");
    })
...
export async function down(knex) {
  ...
  await knex.raw(
    'ALTER TABLE "SnapshotAccountTransaction" DROP CONSTRAINT "snapshotaccounttransaction_snapshotaccountid_foreign";',
  );
