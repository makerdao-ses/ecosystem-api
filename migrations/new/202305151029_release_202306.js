...
export async function up(knex) {
    ...
    console.log("Adding budgetId column to budgetStatementLineItem, CoreUnit and SnapshotAccount tables...");
...
export async function down(knex) {
    ...
    console.log('Reverting the change that added budgetId columns to BudgetStatmentLineItem, CoreUnit and SnapshotAccount tables...');
