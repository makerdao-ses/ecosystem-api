...
export async function up(knex) {
  await knex.schema
    ...
    .createTable("BudgetStatementComment", function (table) {
      ...
      table
        .foreign("budgetStatementId")
        .references("BudgetStatement.id")
        .onDelete("CASCADE");
    ...
    .createTable(
      ...
      function (table) {
        console.log(
          "Creating BudgetStatementComment_BudgetStatementCommentAuthor table...",
        );
...
export function down(knex) {
  console.log(
    "Dropping BudgetStatementComment , BudgetStatementComment_BudgetStatementCommentAuthor and BudgetStatementCommentAuthor tables...",
  );
