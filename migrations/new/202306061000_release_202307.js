...
export async function up(knex) {
  console.log(
    "Adding legacyCategory and parentId columns to ExpenseCategory table...",
  );

  await knex.schema.table("ExpenseCategory", (table) => {
    table.enu("legacyCategory", null, {
      useNative: true,
      existingType: true,
      enumName: "CanonicalBudgetCategory",
    });
    table
      .integer("parentId")
      .unsigned()
...
export async function down(knex) {
  console.log(
    "Reverting the change that added legacyCategory and parentId columns to ExpenseCategory table...",
  );
