...
export async function up(knex) {
  console.log(
    "Making snapshot start, end and snapshot account accountAddress nullable...",
  );
...
export async function down(knex) {
  console.log(
    "Reverting the change that Snapshot start, end and SnapshotAccount accountAddress nullable...",
  );
